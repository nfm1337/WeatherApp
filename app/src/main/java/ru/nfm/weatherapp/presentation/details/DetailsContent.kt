...
import ru.nfm.weatherapp.R
import ru.nfm.weatherapp.domain.entity.Forecast
import ru.nfm.weatherapp.domain.entity.Weather
import ru.nfm.weatherapp.presentation.extensions.formatToFullDate
import ru.nfm.weatherapp.presentation.extensions.formatToShortDayOfWeek
import ru.nfm.weatherapp.presentation.extensions.tempToFormattedString
import ru.nfm.weatherapp.presentation.ui.theme.CardGradients
    ...
    Scaffold(
        ...
        topBar = {
            TopBar(
                ...
                onBackClicked = { component.onClickBack() },
...
private fun Forecast(forecast: Forecast) {
    Column(
        ...
        Text(
            text = forecast.currentWeather.date.formatToFullDate(),
            style = MaterialTheme.typography.titleLarge
        )
        Spacer(modifier = Modifier.weight(1f))
...
private fun RowScope.SmallWeatherCard(weather: Weather) {
    Card(
        ...
        Column(
            ...
            Text(text = weather.date.formatToShortDayOfWeek())
        }
    }
}
